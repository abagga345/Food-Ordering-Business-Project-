...
export default function Home() {
  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center my-10 w-[60%] mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-[40%]">
          ...
          <Link
            href="/login"
            className="text-black p-2 rounded font-semibold hover:scale-105 hover:bg-[#c4397b] border-solid border-pink-400 border-2 text-center hover:text-white"
          >
            Log In
          </Link>
        </form>

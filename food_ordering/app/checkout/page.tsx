            ...
            <div className="relative">
              ...
              >
                ...
                <div className="ml-5">
                  ...
                  {/* <p className="text-slate-500 text-sm leading-6">+₹40 COD charge</p> */}
                </div>
              </label>
            </div>
          </div>
            ...
            <div className="flex">
              <div className="relative w-7/12 flex-shrink-0">
                <input
                  ...
                  id="card-no"
                  name="card-no"
                  className="w-full rounded-md border border-gray-200 px-2 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-green-500 focus:ring-green-500"
              ...
              <input
                type="text"
                name="credit-expiry"
                className="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-green-500 focus:ring-green-500"
                placeholder="MM/YY"
              />
              <input
                type="text"
                name="credit-cvc"
                className="w-1/6 flex-shrink-0 rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-green-500 focus:ring-green-500"
                placeholder="CVC"
              />
            </div> */}
            <label

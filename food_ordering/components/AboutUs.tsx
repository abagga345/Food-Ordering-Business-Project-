  ...
  return (
    <div className="mx-28 flex flex-col gap-10 mb-32 mt-20">
      <div className="flex mb-20 gap-32 p-16 rounded-lg">
        <div className="w-[50%] flex flex-col gap-6">
          ...
          <p className=" text-gray-600 text-lg leading-relaxed">
            ...
            alias, laborum accusantium consequuntur modi amet nemo corrupti
            labore, praesentium voluptatibus sint, maxime dignissimos expedita
            ipsum libero odio fugit quae. <br />
            <br /> Perferendis! Maiores consequuntur in natus tenetur quibusdam
            labore, autem magni dolor dignissimos et ullam eveniet animi
            incidunt ipsum illum quidem sunt ab nemo voluptate enim ut fuga
          </p>
        </div>
        <img
          className="w-[50%] rounded-lg"
          src="https://www.farmdidi.com/cdn/shop/articles/Mango-Pickle-Blog-tile_1445x.webp?v=1670990749"
          alt=""
        />
      </div>
      ...
      <div className="flex flex-row-reverse mb-20 gap-32 p-16 rounded-lg">
        ...
        <img
          className="w-[50%] rounded-lg"
          src="https://media.assettype.com/homegrown%2Fimport%2Fbook%2F12241-qzhkgpfhew-1595237364.jpeg"
          alt=""
        />
      </div>
      ...
      <div className="flex justify-between mb-20 gap-20 p-16 rounded-lg items-center">
        <div className="text-lg">
          ...
          <div className="mb-10">
            ...
            <p>
              Shop No, 6675, Khari Baoli Rd, <br /> Fatehpuri, Chandni Chowk,
          ...
          <div className="mb-10">
            ...
            <p className="mb-2">
              Drop us an email at{" "}
              <a
                href="mailto:achar6ranga.query@gmail.com"
                className="text-blue-600"
              >
                achar6ranga.query@gmail.com
              </a>
            </p>
          </div>
